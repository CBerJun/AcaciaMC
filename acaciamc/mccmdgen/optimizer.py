...
class Optimizer(cmds.FunctionsManager, metaclass=ABCMeta):
    def optimize(self):
        ...
        if self.init_file is None:
            raise ValueError("Call generate_init_file() first!")
    ...
    def entry_files(self) -> Iterable[cmds.MCFunctionFile]:
        ...
        are not referenced. The init file generated by
        `generate_init_file` is always an entry file.
        """
        pass
